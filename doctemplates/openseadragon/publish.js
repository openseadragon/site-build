...
function generate(title, docs, filename, resolveLinks) {
    ...
    var docData = {
        env: env,
        pageTitle: title,
        title: title.startsWith('OpenSeadragon') ? title : 'OpenSeadragon ' + title,
        docs: docs
    };
...
function buildNav(members) {
    ...
    nav += buildEventsNav(members.events, seen, linkto);
...
function buildEventsNav(events, seen, linkto) {
    var nav = '';
    if (events.length) {
        //**debug**
        //if (debugMode) {
